...
public class ExpectedOutcomeTable {
  ...
  private final @Modifiable @IteratorPolyMod List<ExecutableBooleanExpression> postConditions =
      new ArrayList<>();
   ...
   */
  private final @Modifiable @IteratorPolyMod List<List<ThrowsClause>> exceptionSets =
      new ArrayList<>();
